...
const Banner = () => {
  return (
    // <Container>
    <div className='text-white pt-32 w-full flex flex-col items-center gap-y-24 justify-center px-12 relative pb-96 '>
      ...
      <div className='w-4/5 mt-16 max-w-4xl rounded-xl absolute top-full -translate-y-1/2'>
